...
if __name__ == '__main__':
    ...
    for o, a in opt_list:
        ...
        if o in ('-l', '--l'):
            ligand_filename = a
            #ligand_filename = os.path.basename(a) #### Gaggini Lorenzo, 12/12/2024 -> swaped the commented line to keep the entire path for the filename_ligand due to MGTools convention.
            # in my usecase where ligand and receptor where in the same directory, receptor files where found but not ligand files.
