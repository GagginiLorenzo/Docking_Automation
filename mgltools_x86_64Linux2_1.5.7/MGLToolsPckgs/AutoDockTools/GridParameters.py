...
# $Header: /mnt/raid/services/cvs/python/packages/share1.5/AutoDockTools/GridParameters.py,v 1.39.6.2 2016/02/11 09:24:07 annao Exp $
#
#
...
class GridParameter4FileMaker:
    ...
    def set_receptor(self, receptor_filename, gpf_filename=None):
        ...
        #receptor_filename = os.path.basename(receptor_filename) Gaggini Lorenzo, 12/12/2024 -> commented this line to keep the entire path for the filename_receptor due to strange behavior where ligand and receptor
        #where in the same directory, ligand files where found but not receptor files.
